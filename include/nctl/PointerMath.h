...
void *PointerMath::add(void *ptr, size_t amount)
{
	return reinterpret_cast<void *>(reinterpret_cast<uintptr_t>(ptr) + amount);
}

void *PointerMath::subtract(void *ptr, size_t amount)
{
	return reinterpret_cast<void *>(reinterpret_cast<uintptr_t>(ptr) - amount);
}

uintptr_t PointerMath::add(void *first, void *second)
{
	return reinterpret_cast<uintptr_t>(first) + reinterpret_cast<uintptr_t>(second);
}

uintptr_t PointerMath::subtract(void *first, void *second)
{
	return reinterpret_cast<uintptr_t>(first) - reinterpret_cast<uintptr_t>(second);
}

void *PointerMath::align(void *ptr, uint8_t alignment)
{
	return reinterpret_cast<void *>((reinterpret_cast<uintptr_t>(ptr) + static_cast<uintptr_t>(alignment - 1)) & static_cast<uintptr_t>(~(alignment - 1)));
}

uint8_t PointerMath::alignAdjustment(const void *ptr, uint8_t alignment)
{
...
uint8_t PointerMath::alignWithHeader(const void *ptr, uint8_t alignment, uint8_t headerSize)
{
